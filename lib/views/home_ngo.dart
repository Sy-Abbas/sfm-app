                                                          ...
                                                          itemBuilder:
                                                            ...
                                                            return index == 0
                                                                ...
                                                                : cuisineData[
                                                                    ...
                                                                    ? (_foodListingItem(
                                                                        context,
                                                                        cuisineData[selectedData]![index]
                                                                            [1],
                                                                        cuisineData[selectedData]![index]
                                                                            [2],
                                                                        cuisineData[selectedData]![index]
                                    ...
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<List<String>> data =
                                            snapshot.data!;
                                        data.sort((a, b) => int.parse(b[4])
                                            .compareTo(int.parse(a[4])));
                                        data.sort((a, b) {
                                        ...
                                        if (data.isNotEmpty) {
                                          int numberOfRequest = data.length;
                                          return Column(
                                            children: [
                                              ListView.builder(
                                                  physics:
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        CircleAvatar(
          ...
          foregroundImage: filePath == ""
              ...
              : NetworkImage(filePath) as ImageProvider<Object>?,
        ),
        const SizedBox(
          height: 7,
        ),
...
Stream<void> getDataStream() async* {
  ...
  yield* FirebaseFirestore.instance
    ...
    filePath = snapshot["Profile Picture"];
  });
}
